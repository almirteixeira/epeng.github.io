    ...
    var Formoid = (function () {
        ...
        Form.prototype.send = function (data, beforeStart) {
            ...
            $ajax(API_URL, {
                ...
                var error = 'O seu ebook foi enviado por e-mail!';
                if ('onLine' in navigator && !navigator.onLine)
                    error += 'Sem conexão com a Internet.';
                else error += 'Seu ebook foi enviado por e-mail';
                var url = "https://docs.google.com/forms/d/e/1FAIpQLSdry1cPFzdiHLUt2ATdGmkF1JJZ6EoKmvQ6uPVmtROUh47VNg/formResponse?"
  url = url + "entry.1245017389= " + document.getElementById("nomeform").value + "&entry.332247128=" + document.getElementById("phoneform").value + "&entry.399909403=" + document.getElementById("emailform").value;
